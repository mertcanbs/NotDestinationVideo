...
@Observable class VideoLibrary {
    ...
    private let upNextURL = URL.documentsDirectory.appendingPathComponent("UpNextVideos.json")
    ...
    private func loadVideos() -> [Video] {
        guard let url = URL(string: "https://iv13q1s5na.execute-api.us-east-2.amazonaws.com/videos") else {
